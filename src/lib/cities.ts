...
export const FEATURED_CITIES: City[] = [
  CITIES.find((c) => c.id === "c-iasi")     ?? CITIES[0],
  CITIES.find((c) => c.id === "c-tokyo")    ?? CITIES[0],
  CITIES.find((c) => c.id === "c-newyork")  ?? CITIES[0],
  CITIES.find((c) => c.id === "c-saopaulo") ?? CITIES[0],
  CITIES.find((c) => c.id === "c-london")   ?? CITIES[0],
  CITIES.find((c) => c.id === "c-mumbai")   ?? CITIES[0],
  CITIES.find((c) => c.id === "c-cairo")    ?? CITIES[0],
  CITIES.find((c) => c.id === "c-sydney")   ?? CITIES[0],
];
